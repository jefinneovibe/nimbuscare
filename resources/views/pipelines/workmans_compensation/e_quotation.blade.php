        ...
        <div class="card_content">
            <div class="edit_sec clearfix">
                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            <li class="complete"><em><a href="{{ url('e-questionnaire') }}">E-Questionnaire</a></em></li>
                            <li class="complete"><em><a href="{{ url('e-slip') }}">E-Slip</a></em></li>
                            <li class="current"><em>E-quotation</em></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form_group">
                            <label class="form_label bold">Rate required (Admin) <span>*</span></label>
                            <input class="form_input" name="name" type="text">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form_group">
                            <label class="form_label bold">Rate required (Non-Admin) <span>*</span></label>
                            <input class="form_input" name="name" type="text">
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <a href="#" class="btn btn-primary btn_action pull-right">Proceed</a>
            </div>
        </div>
    </div>
@endsection
