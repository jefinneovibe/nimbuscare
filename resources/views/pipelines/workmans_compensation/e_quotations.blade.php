                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            <li class="complete"><a href="{{url('e-questionnaire/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Questionnaire</em></a></li>
                            <li class="complete"><a href="{{url('e-slip/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            @if($pipeline_details['status']['status'] == 'E-quotation')
                                <li class="current"><a href="{{url('e-quotation/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Quotation</em></a></li>
                                ...
                                <li class="active_arrow"><a href="{{url('e-quotation/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Quotation</em></a></li>
                                <li class="current"><a href="{{url('e-comparison/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                                <li><em>Quote Amendment</em></li>
                                <li><em>Approved E Quote</em></li>
                                {{--<li><em>Issuance</em></li>--}}
                                        ...
                                        <div class="material-table table-responsive" style="border-bottom: none;overflow: hidden">
                                            <table class="table table-bordered"  style="border-bottom: none">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="main_answer"><div class="ans">{{number_format($pipeline_details['formData']['extendedLiability'])}}</div></td>

                                                </tr>

                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Medical Expense (In AED) </label></div></td>
                                                    <td class="main_answer"><div class="ans">{{number_format($pipeline_details['formData']['medicalExpense'])}}</div></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="main_answer"><div class="ans">{{number_format($pipeline_details['formData']['repatriationExpenses'])}}</div></td>
                                                </tr>
                                                    ...
                                                    @else
                                                        @for ($i = 0; $i < $total_insure_count; $i++)
                                                            @if(array_key_exists($i,$insures_details))
                                                                ...
                                                                <div class="ans">
                                                                    <span id='div_scaleOfCompensation_{{$insures_details[$i]['uniqueToken']}}'
                                                                          data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="
                                                                      <input id='scaleOfCompensation_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['scaleOfCompensation']?:'--'}}' required>
                                                                      <label class='error' id='scaleOfCompensation_{{$insures_details[$i]['uniqueToken']}}-error'></label>
                                                                      <button name='{{$insures_details[$i]['uniqueToken']}}' value='scaleOfCompensation' onclick='fun(this)'>Update</button>
                                                                      <button name='{{$insures_details[$i]['uniqueToken']}}' value='scaleOfCompensation' onclick='cancel(this)'>
                                                                      <i class='material-icons'>close</i></button>"
                                                                          data-container="body">{{$insures_details[$i]['scaleOfCompensation']?:'--'}}
                                                                </span>
                                                                </div>
                                                                </td>
                                                            @else
                                                    ...
                                                    @else
                                                        @for ($i = 0; $i < $total_insure_count; $i++)
                                                            @if(array_key_exists($i,$insures_details))
                                                                ...
                                                                <i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['extendedLiability']}}
                                                            </span>
                                                                    </div>
                                                                </td>
                                                            @else
                                                    ...
                                                    @else
                                                        @for ($i = 0; $i < $total_insure_count; $i++)
                                                            @if(array_key_exists($i,$insures_details))
                                                                <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}">
                                                                    <div class="ans">
                                                                <span id="div_medicalExpense_{{$insures_details[$i]['uniqueToken']}}"
                                                                      data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="
                                                                      <input id='medicalExpense_{{$insures_details[$i]['uniqueToken']}}' type='text' value='@if(is_numeric($insures_details[$i]['medicalExpense'])==true){{number_format($insures_details[$i]['medicalExpense'])}} @else {{$insures_details[$i]['medicalExpense']}}@endif' required>
                                                                      <label class='error' id='medicalExpense_{{$insures_details[$i]['uniqueToken']}}-error'></label>
                                                                      <button name='{{$insures_details[$i]['uniqueToken']}}' value='medicalExpense' onclick='fun(this)'>Update</button>
                                                                      <button name='{{$insures_details[$i]['uniqueToken']}}' value='medicalExpense' onclick='cancel(this)'>
                                                                      <i class='material-icons'>close</i></button>" data-container="body">@if(is_numeric($insures_details[$i]['medicalExpense'])==true){{number_format($insures_details[$i]['medicalExpense'])}} @else {{$insures_details[$i]['medicalExpense']}}@endif
                                                                </span>
                                                                    </div>
                                                                </td>
                                                            @else
                                                    ...
                                                    @else
                                                        @for ($i = 0; $i < $total_insure_count; $i++)
                                                            @if(array_key_exists($i,$insures_details))
                                                                <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}">
                                                                    <div class="ans">
                                                                <span id="div_repatriationExpenses_{{$insures_details[$i]['uniqueToken']}}"
                                                                      data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="
                                                                      <input id='repatriationExpenses_{{$insures_details[$i]['uniqueToken']}}' type='text' value='@if(is_numeric($insures_details[$i]['repatriationExpenses'])==true){{number_format($insures_details[$i]['repatriationExpenses'])}} @else {{$insures_details[$i]['medicalExpense']}}@endif' required>
                                                                      <label class='error' id='repatriationExpenses_{{$insures_details[$i]['uniqueToken']}}-error'></label>
                                                                      <button name='{{$insures_details[$i]['uniqueToken']}}' value='repatriationExpenses' onclick='fun(this)'>Update</button>
                                                                      <button name='{{$insures_details[$i]['uniqueToken']}}' value='repatriationExpenses' onclick='cancel(this)'>
                                                                      <i class='material-icons'>close</i></button>" data-container="body">@if(is_numeric($insures_details[$i]['repatriationExpenses'])==true){{number_format($insures_details[$i]['repatriationExpenses'])}} @else {{$insures_details[$i]['repatriationExpenses']}} @endif
                                                                </span>
                                                                    </div>
                                                                </td>
                                                            @else
                                                                    ...
                                                                    @else
                                                                        @if(isset($insures_details[$i]['HoursPAC']['isAgree']))
                                                                            @if(@$insures_details[$i]['HoursPAC']['comment']!="")
                                                                                <td class="tooltip_sec insure_check_{{@$insures_details[$i]['uniqueToken']}}">
                                                                                    <div class="ans">
            <span id="div_HoursPAC_{{@$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true"
              data-content="<input id='HoursPAC_{{@$insures_details[$i]['uniqueToken']}}' type='text' value='{{@$insures_details[$i]['HoursPAC']['isAgree']}}'>
            <label class='error' id='HoursPAC_{{$insures_details[$i]['uniqueToken']}}-error'></label>
            <button name='{{$insures_details[$i]['uniqueToken']}}' value='HoursPAC' onclick='fun(this)'>Update</button>
            <button name='{{$insures_details[$i]['uniqueToken']}}' value='HoursPAC' onclick='cancel(this)'><i class='material-icons'>close</i></button>"
              data-container="body">{{@$insures_details[$i]['HoursPAC']['isAgree']}}
            </span>
                                                                                    ...
                                                                                    <span id="cancel_HoursPAC_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing comment" data-html="true"
                                                                                    data-content="<input id='HoursPAC_comment_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['HoursPAC']['comment']}}'>
                                                                               <label class='error' id='HoursPAC_comment_{{$insures_details[$i]['uniqueToken']}}-error'>
                                                                               </label><button name='{{$insures_details[$i]['uniqueToken']}}' value='HoursPAC' onclick='commentEdit(this)'>Update</button>
                                                                               <button name='{{$insures_details[$i]['uniqueToken']}}' value='HoursPAC' onclick='commentCancel(this)'><i class='material-icons'>close</i></button"
                                                                                    data-container="body">
                                                                                                                <button type="button">
                                                                                                                        <i class="material-icons">edit</i>
                                                                                                                    </button>
                                                                            ...
                                                                            @else
                                                                                <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}">
                                                                                    <div class="ans">
                                                                                    <span id="div_HoursPAC_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top"
                                              title="Edit existing value" data-html="true" data-content="<input id='HoursPAC_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{@$insures_details[$i]['HoursPAC']['isAgree']}}'>
            <label class='error' id='HoursPAC_{{$insures_details[$i]['uniqueToken']}}-error'></label>
            <button name='{{$insures_details[$i]['uniqueToken']}}' value='HoursPAC' onclick='fun(this)'>Update</button>
            <button name='{{$insures_details[$i]['uniqueToken']}}' value='HoursPAC' onclick='cancel(this)'>
            <i class='material-icons'>close</i></button>" data-container="body">{{@$insures_details[$i]['HoursPAC']['isAgree']}}</span></div></td>
                                                                            @endif
                                                                        @else
                                                                                <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}">  <div class="ans">--</div></td>
                                                                        @endif
                                                            ...
                                                            @for ($i = 0; $i < $total_insure_count; $i++)
                                                                @if(array_key_exists($i,$insures_details))
                                                                    @if($herniaCover=='No')
                                                                        <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"> <div class="ans">--</div></td>
                                                                    @else
                                                                        @if(isset($insures_details[$i]['herniaCover']['isAgree']))
                                                                            @if($insures_details[$i]['herniaCover']['comment']!="")
                                                                                <td class="tooltip_sec insure_check_{{$insures_details[$i]['uniqueToken']}}">
                                                                                    <div class="ans">
                                                                                    <span id="div_herniaCover_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='herniaCover_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['herniaCover']['isAgree']}}' required><label class='error' id='herniaCover_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='herniaCover' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='herniaCover' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['herniaCover']['isAgree']}}
                                                                                    </span>
                                                                                          ...
                                                                                          <div class="post_comments">
                                                                                                <div class="post_comments_main clearfix">
                                                                                                    <div class="media">
                                                                                                        ...
                                                                                                        <div class="media-right">
                                                                                                                <span id="cancel_herniaCover_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing comment" data-html="true"
                                                                                                                data-content="<input id='herniaCover_comment_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['herniaCover']['comment']}}'>
                                                                                                           <label class='error' id='herniaCover_comment_{{$insures_details[$i]['uniqueToken']}}-error'>
                                                                                                           </label><button name='{{$insures_details[$i]['uniqueToken']}}' value='herniaCover' onclick='commentEdit(this)'>Update</button>
                                                                                                           <button name='{{$insures_details[$i]['uniqueToken']}}' value='herniaCover' onclick='commentCancel(this)'><i class='material-icons'>close</i></button"
                                                                                                                data-container="body">
                                                                                                                <button type="button">
                                                                                                                        <i class="material-icons">edit</i>
                                                                                                                    </button>
                                                                            ...
                                                                            @else
                                                                                <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}">  <div class="ans"><span id="div_herniaCover_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='herniaCover_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['herniaCover']['isAgree']}}' required><label class='error' id='herniaCover_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='herniaCover' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='herniaCover' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['herniaCover']['isAgree']}}</span></div></td>
                                                                            @endif
                                                                        @else
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}">  <div class="ans">--</div></td>
                                                                        @endif
                                                                    ...
                                                                    @else
                                                                        @if(isset($insures_details[$i]['legalCost']))
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">
                                                                                    <span id="div_legalCost_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='legalCost_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['legalCost']}}' required><label class='error' id='legalCost_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='legalCost' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='legalCost' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['legalCost']}}</span></div></td>
                                                                        @else
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">--</div></td>
                                                                        @endif
                                                                    @endif
                                                                ...
                                                                @if(array_key_exists($i,$insures_details))
                                                                    ...
                                                                    @else
                                                                        @if(isset($insures_details[$i]['flightCover']))
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans"><span id="div_flightCover_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='flightCover_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['flightCover']}}' required><label class='error' id='flightCover_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='flightCover' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='flightCover' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['flightCover']}}</span></div></td>
                                                                        @else
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">--</div></td>
                                                                        @endif
                                                                    @endif
                                                                ...
                                                                @if(array_key_exists($i,$insures_details))
                                                                    ...
                                                                    @else
                                                                        @if(isset($insures_details[$i]['diseaseCover']))
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans"><span id="div_diseaseCover_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='diseaseCover_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['diseaseCover']}}' required><label class='error' id='diseaseCover_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='diseaseCover' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='diseaseCover' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['diseaseCover']}}</span></div></td>
                                                                        @else
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">--</div></td>
                                                                        @endif
                                                                    @endif
                                                ...
                                                @if($overtimeWorkCover == 'Yes')
                                                    <tr>
                                                        ...
                                                        @else
                                                            @for ($i = 0; $i < $total_insure_count; $i++)
                                                                @if(array_key_exists($i,$insures_details))
                                                                    @if($overtimeWorkCover=='No')
                                                                        <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">--</div></td>
                                                                    @else
                                                                        @if(isset($insures_details[$i]['overtimeWorkCover']))
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans"><span id="div_overtimeWorkCover_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='overtimeWorkCover_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['overtimeWorkCover']}}' required><label class='error' id='overtimeWorkCover_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='overtimeWorkCover' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='overtimeWorkCover' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['overtimeWorkCover']}}</span></div></td>
                                                                        @else
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">--</div></td>
                                                                        @endif
                                                                    @endif
                                                                                                ...
                                                                                                <div class="post_comments_main clearfix">
                                                                                                    <div class="media">
                                                                                                        ...
                                                                                                        <div class="media-right">
                                                                                                           ...
                                                                                                           <button name='{{$insures_details[$i]['uniqueToken']}}' value='brokersClaimClause' onclick='commentEdit(this)'>Update</button>
                                                                ...
                                                                @if(array_key_exists($i,$insures_details))
                                                                    ...
                                                                    @else
                                                                        @if(isset($insures_details[$i]['offshoreCheck']))
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans"><span id="div_offshoreCheck_{{$insures_details[$i]['uniqueToken']}}" data-toggle="popover" data-placement="top" title="Edit existing value" data-html="true" data-content="<input id='offshoreCheck_{{$insures_details[$i]['uniqueToken']}}' type='text' value='{{$insures_details[$i]['offshoreCheck']}}' required><label class='error' id='offshoreCheck_{{$insures_details[$i]['uniqueToken']}}-error'></label><button name='{{$insures_details[$i]['uniqueToken']}}' value='offshoreCheck' onclick='fun(this)'>Update</button><button name='{{$insures_details[$i]['uniqueToken']}}' value='offshoreCheck' onclick='cancel(this)'><i class='material-icons'>close</i></button>" data-container="body">{{$insures_details[$i]['offshoreCheck']}}</span></div></td>
                                                                        @else
                                                                            <td class="insure_check_{{$insures_details[$i]['uniqueToken']}}"><div class="ans">--</div></td>
                                                                        @endif
                                                                    @endif
            ...
            submitHandler: function (form, event) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == 1) {
                            window.location.href = "{{url('imported-list')}}";
                        }
        ...
        $("#e_quat_form").validate({
            ...
            submitHandler: function (form,event) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result== 'success') {
                            window.location.href = '{{url('e-comparison/'.$pipeline_details->_id)}}';
                        }
                    }
                });
            }
