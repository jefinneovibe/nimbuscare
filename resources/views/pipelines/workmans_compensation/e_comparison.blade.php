                    ...
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            ...
                            @if($pipeline_details['status']['status'] == 'Quote Amendment')
                                <li class = active_arrow><a href="{{url('e-comparison/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                        ...
                        <div class="material-table">
                            <div class="table-header">
                                ...
                                <div class="table_header_action">
                                    ...
                                    <a target="_blank" href="{{url('comparison-pdf/'.$pipeline_details->_id)}}" class="btn pink_btn">Download as pdf</a>
                                </div>
                            </div>
                                    ...
                                    <div class="material-table table-responsive">
                                        <table class="table comparison table-bordered" style="table-layout: auto">
                                            ...
                                            @if(($pipeline_details['formData']['hiredWorkersDetails']['hasHiredWorkers']==true))
                                                ...
                                                @endif @if(($pipeline_details['formData']['offShoreEmployeeDetails']['hasOffShoreEmployees']==true) &&  $pipeline_details['formData']['offshoreCheck'])
                                                <tr>
