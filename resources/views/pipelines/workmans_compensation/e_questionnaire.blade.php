                    ...
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            ...
                            @elseif($PipelineItems['status']['status']=='E-comparison')
                                ...
                                <li class="current"><a href="{{url('e-comparison/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                                <li><em>Quote Amendment</em></li>
                                <li><em>Approved E Quote</em></li>
                                {{--<li><em>Issuance</em></li>--}}
...
//            }
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result== 'success') {
                        window.location.href = '{{url('e-slip/'.$eQuestionnaireid)}}';
                    }
                }
            });
        }
