                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            ...
                            <li class="complete"><a href="{{url('e-comparison/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li class="complete"><a href="{{url('quot-amendment/'.$pipelineId)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                            <li @if($pipeline_details['status']['status']!='Issuance') class="current" @else class="complete" @endif><a href="{{url('approved-quot/'.$pipelineId)}}" style="color: #ffffff;"><em>Approved E Quote</em></a></li>
                            ...
                            <div class="material-table" style="margin-bottom: 20px">
                                ...
                                <div class="table-responsive" style="margin-bottom: 20px">
                                    <table class="comparison table table-bordered">
                                        ...
                                        @endif @if($pipeline_details['formData']['offShoreEmployeeDetails']['hasOffShoreEmployees']==true)
                                            <tr>
                                        ...
                                        <div class="">
                                            <table class="comparison table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input class="form_input number" name="premium" id="premium" onkeyup="commission()" value="@if($pipeline_details['accountsDetails']['premium']!=''){{number_format(@$pipeline_details['accountsDetails']['premium'])}}@endif">
                                                    </td>
                                                </tr>
                                                <tr>
