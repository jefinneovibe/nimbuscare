                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            <li class="complete"><a href="{{url('business_interruption/e-questionnaire/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Questionnaire</em></a></li>
                            <li class="complete"><a href="{{url('business_interruption/e-slip/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li class="complete"><a href="{{url('business_interruption/e-quotation/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Quotation</em></a></li>
                            <li class="complete"><a href="{{url('business_interruption/e-comparison/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li class="complete"><a href="{{url('business_interruption/quot-amendment/'.$pipelineId)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                            <li @if($pipeline_details['status']['status']!='Issuance') class="current" @else class="complete" @endif><a href="{{url('business_interruption/approved-quot/'.$pipelineId)}}" style="color: #ffffff;"><em>Approved E Quote</em></a></li>
                                                        ...
                                                        @if(isset($insures_details['custExtension']['comment']))
                                                            @if($insures_details['custExtension']['comment']!="")
                                                                <td class="tooltip_sec">
                                                                    ...
                                                                    {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                    title="" data-container="body" data-original-title="{{$insures_details['custExtension']['comment']}}"></i> --}}
                                                                </td>
                                                            @else
                                                        ...
                                                        @if(isset($insures_details['accountants']['comment']))
                                                            @if($insures_details['accountants']['comment']!="")
                                                                <td class="tooltip_sec">
                                                                    ...
                                                                    {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                    title="" data-container="body" data-original-title="{{$insures_details['accountants']['comment']}}"></i> --}}
                                                                </td>
                                                            @else
                                                            ...
                                                            @if(isset($insures_details['denialAccess']['comment']))
                                                                @if($insures_details['denialAccess']['comment']!="")
                                                                    <td class="tooltip_sec">
                                                                        ...
                                                                        {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                        title="" data-container="body" data-original-title="{{$insures_details['denialAccess']['comment']}}"></i> --}}
                                                                    </td>
                                                                @else
                                                        ...
                                                        @if(isset($insures_details['premiumClause']['comment']))
                                                            @if($insures_details['premiumClause']['comment']!="")
                                                                <td class="tooltip_sec">
                                                                    ...
                                                                    {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                    title="" data-container="body" data-original-title="{{$insures_details['premiumClause']['comment']}}"></i> --}}
                                                                </td>
                                                            @else
                                                        ...
                                                        @if(isset($insures_details['utilityClause']['comment']))
                                                            @if($insures_details['utilityClause']['comment']!="")
                                                                <td class="tooltip_sec">
                                                                    ...
                                                                    {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                    title="" data-container="body" data-original-title="{{$insures_details['utilityClause']['comment']}}"></i> --}}
                                                                </td>
                                                            @else
                                                        ...
                                                        @if(isset($insures_details['bookedDebts']['comment']))
                                                            @if($insures_details['bookedDebts']['comment']!="")
                                                                <td class="tooltip_sec">
                                                                    ...
                                                                    {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                    title="" data-container="body" data-original-title="{{$insures_details['bookedDebts']['comment']}}"></i> --}}
                                                                </td>
                                                            @else
                                                    ...
                                                    @if(isset($insures_details['lossAdjuster']['comment']))
                                                        @if($insures_details['lossAdjuster']['comment']!="")
                                                            <td class="tooltip_sec">
                                                                ...
                                                                {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                                title="" data-container="body" data-original-title="{{$insures_details['lossAdjuster']['comment']}}"></i> --}}
                                                            </td>
                                                        @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['powerSupply']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['powerSupply']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['condition1']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['condition1']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['condition2']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['condition2']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['bookofDebts']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['bookofDebts']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['rent']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['rent']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['hasaccomodation']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['hasaccomodation']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['costofConstruction']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['costofConstruction']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['ContingentExpense']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['ContingentExpense']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    ...
                                                    @if($insures_details['interuption']['comment']!="")
                                                        <td class="tooltip_sec">
                                                            ...
                                                            {{-- <i class="fa fa-comments" data-toggle="tooltip" data-placement="bottom" 
                                                            title="" data-container="body" data-original-title="{{$insures_details['interuption']['comment']}}"></i> --}}
                                                        </td>
                                                    @else
                                                ...
                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Rate/premium </label></div></td>
                                                            ...
                                                            @if(isset($insures_details['ratep']) && $insures_details['ratep']!='')
                                                                ...
                                                                <td>{{number_format($insures_details['ratep'],2)}}</td>
                                                ...
                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Brokerage</label></div></td>
                                                            ...
                                                            @if(isset($insures_details['brokerage']) && $insures_details['brokerage']!='')
                                                                ...
                                                                <td>{{number_format($insures_details['brokerage'],2)}}</td>
                                                ...
                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Special Condition</label></div></td>
                                                            ...
                                                            @if(isset($insures_details['spec_condition']) && $insures_details['spec_condition']!='')
                                                                ...
                                                                <td>{{number_format($insures_details['spec_condition'],2)}}</td>
                                                ...
                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Warranty</label></div></td>
                                                            ...
                                                            @if(isset($insures_details['warranty']) && $insures_details['warranty']!='')
                                                                ...
                                                                <td>{{number_format($insures_details['warranty'],2)}}</td>
                                                ...
                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Exclusion</label></div></td>
                                                            ...
                                                            @if(isset($insures_details['exclusion']) && $insures_details['exclusion']!='')
                                                                ...
                                                                <td>{{number_format($insures_details['exclusion'],2)}}</td>
