                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            <li class="complete"><a href="{{url('money/e-questionnaire/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Questionnaire</em></a></li>
                            <li class="complete"><a href="{{url('money/e-slip/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li class="complete"><a href="{{url('money/e-quotation/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Quotation</em></a></li>
                            <li class="complete"><a href="{{url('money/e-comparison/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li class="complete"><a href="{{url('money/quot-amendment/'.$pipelineId)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                            <li @if($pipeline_details['status']['status']!='Issuance') class="current" @else class="complete" @endif><a href="{{url('money/approved-quot/'.$pipelineId)}}" style="color: #ffffff;"><em>Approved E Quote</em></a></li>
                                    ...
                                    <table class="comparison table table-bordered">
                                        ...
                                        @if($pipeline_details['formData']['transitdRate'])
                                            <tr>
                                                ...
                                                @if(isset($insures_details['transitdRate']) && $insures_details['transitdRate']!='')
                                        ...
                                        @if($pipeline_details['formData']['safeRate'])
                                            <tr>
                                                ...
                                                @if(isset($insures_details['safeRate']) && $insures_details['safeRate']!='')
                                        ...
                                        @if($pipeline_details['formData']['premiumTransit'])
                                            <tr>
                                                ...
                                                @if(isset($insures_details['premiumTransit']) && $insures_details['premiumTransit']!='')
                                        ...
                                        @if($pipeline_details['formData']['premiumSafe'])
                                            <tr>
                                                ...
                                                @if(isset($insures_details['premiumSafe']) && $insures_details['premiumSafe']!='')
