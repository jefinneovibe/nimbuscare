...
@section('content')
    ...
    <div class="section_details">
        <div class="card_header clearfix">
            <h3 class="title" style="margin-bottom: 8px;">CONTRACTOR`S PLANT AND MACHINERY
            </h3>
        </div>
                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            ...
                            <li class="complete"><a href="{{url('contractor-plant/e-comparison/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Comparision</em></a></li>
                            @if($pipeline_details['status']['status'] == 'Approved E Quote')
                                <li class = active_arrow><a href="{{url('contractor-plant/quot-amendment/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
