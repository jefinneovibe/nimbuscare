                    ...
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            ...
                            @if($pipeline_details['status']['status'] == 'Quote Amendment')
                                <li class = active_arrow><a href="{{url('fireperils/e-comparison/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                        ...
                        <div class="material-table">
                            <div class="table-header">
                                ...
                                <div class="table_header_action">
                                    ...
                                    <a target="_blank" href="{{url('fireperils/comparison-pdf/'.$pipeline_details->_id)}}" class="btn pink_btn">Download as pdf</a>
                                </div>
                            </div>
