                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            <li class="complete"><a href="{{url('fireperils/e-questionnaire/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Questionnaire</em></a></li>
                            <li class="complete"><a href="{{url('fireperils/e-slip/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li class="complete"><a href="{{url('fireperils/e-quotation/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Quotation</em></a></li>
                            <li class="complete"><a href="{{url('fireperils/e-comparison/'.$pipelineId)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li class="complete"><a href="{{url('fireperils/quot-amendment/'.$pipelineId)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                            <li @if($pipeline_details['status']['status']!='Issuance') class="current" @else class="complete" @endif><a href="{{url('fireperils/approved-quot/'.$pipelineId)}}" style="color: #ffffff;"><em>Approved E Quote</em></a></li>
                                        ...
                                        <div class="">
                                            <table class="comparison table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input class="form_input number" name="premium" id="premium" onkeyup="commission()" value="@if(isset($pipeline_details['accountsDetails']) && $pipeline_details['accountsDetails']['premium']!=''){{number_format(@$pipeline_details['accountsDetails']['premium'],2)}}@endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="commission_premium_amount" class="form_input number"  onkeyup="commissionPercent()" name="commission_premium_amount" onblur="commission()"
                                                               @if(isset($pipeline_details['accountsDetails']) && $pipeline_details['accountsDetails']['commissionPremium']!='')
                                                               value="{{number_format($pipeline_details['accountsDetails']['commissionPremium'],2)}}"
                                                               {{-- @else
                                                               value="0" --}}
                                                                @endif>
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input  name="insurer_discount" id="insurer_discount" class="form_input number" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['insurerDiscount']!=''){{number_format(@$pipeline_details['accountsDetails']['insurerDiscount'])}}@endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input  name="iib_discount" id="iib_discount" class="form_input number" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['iibDiscount']!=''){{number_format(@$pipeline_details['accountsDetails']['iibDiscount'])}}@endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input name="insurer_fees" id="insurer_fees" class="form_input number" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['insurerFees']!=''){{number_format(@$pipeline_details['accountsDetails']['insurerFees'])}}@endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input  name="iib_fees" id="iib_fees" class="form_input number" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['iibFees']!=''){{number_format(@$pipeline_details['accountsDetails']['iibFees'])}}@endif">
                                                    </td>
                                                </tr>
                                                {{--<tr>--}}
