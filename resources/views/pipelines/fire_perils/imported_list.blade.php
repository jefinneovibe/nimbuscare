...
@section('content')
    <div class="section_details">
        <div class="card_header clearfix">
            <h3 class="title" style="margin-bottom: 8px;">File and Perils</h3>
        </div>
    ...
    <script>
        ...
        $("#import_list_form").validate({
            ...
            submitHandler: function (form,event) {
                ...
                $.ajax({
                    method: 'post',
                    url: '{{url('fireperils/save-imported-list')}}',
                    data: form_data,
                    cache : false,
                    contentType: false,
                    processData: false,
                    success: function (result) {
                        ...
                        if (result.success== 'success') {
                            window.location.href = '{{url('fireperils/e-quotation/'.@$pipeline_id)}}';
