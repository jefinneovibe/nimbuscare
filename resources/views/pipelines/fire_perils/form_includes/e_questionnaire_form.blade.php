                ...
                <div class="col-md-12">
                    <div class="form_group">  
                        ...
                        <label for="single_warehouse" class="radio" style="margin-bottom: 0">
                            <input type="radio" name="warehouse_type" value="Single Warehouse" id="single_warehouse" @if(@$form_data['occupancy']['warehouseType'] == 'Single Warehouse') checked @endif class="hidden"/>
                            <span class="label"></span>
...
<div class="row">
    <div class="col-md-4">
        <div class="form_group">
        <label class="form_label bold">Existence about any hazardous material {{@$form_data['hazardous']['hazardous']}}<span>*</span></label>
            <div class="custom_select">
...
<div class="row">
        ...
        {{-- Construction-Roof --}}
            ...
            <div class="row"  id="cladding_show"   @if(@$form_data['constuctionType']['wallType'] == 'Cladding') style="display:block" @else style="display:none"@endif>
                
                <div class="row" style="padding-left:20px">
                        <div class="col-md-4">
                            <div class="form_group">
                                <label class="form_label bold form_text" style="min-height: 40px">Percentage of Cladding on the overall building exterior wall construction<span>*</span></label>
                                ...
                                <div class="custom_select">
                                    <select class="form_input" id="percentage_cladding" name="percentage_cladding" onchange="validation(this.id)">
                                        <option value="" selected>Select</option>                                 
                                ...
                                <div class="form_group">
                                    ...
                                    <div class="custom_select">
                                            <select class="form_input" id="cladding_show8" name="cladding_ins_mat" onchange="validation(this.id)">
                                                <option value="" selected>Select</option>                                 
                                                <option value="yes"@if(@$form_data['constuctionType']['claddingInsMat'] == true)selected @endif>Yes</option>
                                                <option value="no"@if(@$form_data['constuctionType']['claddingInsMat'] && @$form_data['constuctionType']['claddingInsMat'] == false)selected @endif>No</option>
                                            </select>
                                        </div>
                                </div>
                        </div>
...
{{-- CCTV --}}
        ...
        <div class="col-md-4">
            <div class="form_group">
                <label class="form_label bold">Electricity usage <span>*</span></label>
                <div class="custom_select">
            ...
            <div class="form_group">
                ...
                <div class="">
                    <select class="selectpicker" id="claim_experience_details" name="claim_experience_details" onchange="validation(this.id)">
                        <option value="" selected>Select</option>            
                        <option value="combined_data" @if($form_data['claimExperienceDetails'] =='combined_data') selected @endif>Combined data for Fire & Perils and Business interruption coverages</option>
                        <option value="only_fire" @if($form_data['claimExperienceDetails'] =='only_fire') selected @endif>Only Fire & Perils</option>
                        <option value="separate_fire" @if($form_data['claimExperienceDetails'] =='separate_fire') selected @endif>Separate data for Fire & Perils and Business interruption coverages </option>
                    </select>
                </div>
            </div>
        </div>
...
<div class="card_separation" id="fire_perils" @if($form_data['claimExperienceDetails'] =='separate_fire') style="display:block" @else style="display:none" @endif>
        <div class="row">
                <div class="col-md-12">
                    <div class="form_group">
                        <label class="form_label bold" >Bussiness Interruption<span style="visibility:hidden">*</span></label>
                        <table class="table table-bordered custom_table">
                            <thead>
                            <tr>
                                <th>Year</th>
...
<div class="row">
    <div class="col-md-6">
        <div class="form_group">
            <label class="form_label bold">Do you need to assign the policy to a bank <span>*</span></label>
            <div class="custom_select">
                <select class="form_input" id="bank_policy" name="bank_policy" onchange="validation(this.id)">
                    <option value="" selected>Select</option>            
                    <option value="yes" @if(isset($form_data['bankPolicy']['bankPolicy']) && @$form_data['bankPolicy']['bankPolicy'] == true) selected @endif>Yes</option>
                    <option value="no" @if(isset($form_data['bankPolicy']['bankPolicy']) && @$form_data['bankPolicy']['bankPolicy'] == false) selected @endif>No</option>
                </select>
            </div>
        </div>
    </div>
...
<div id="bank_yes"  @if(@$form_data['bankPolicy']['bankPolicy'] =='true') style="display:block" @else style="display:none" @endif>
    <div class="row">
        <div class="col-md-6">
            <div class="form_group">
                    <label class="form_label form_text">Name of the Bank <span>*</span></label>
                <input class="form_input " name="bank_name" id="bank_name" placeholder="Name of the Bank" 
                @if(@$form_data['bankPolicy']['bankName']!='')  value="{{@$form_data['bankPolicy']['bankName']}}" @endif>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form_group">
                    <label class="form_label form_text">Location / Branch <span>*</span></label>
                <input class="form_input " name="bank_location" id="bank_location" placeholder="Location / Branch" 
                @if(@$form_data['bankPolicy']['bankLocation']!='')  value="{{@$form_data['bankPolicy']['bankLocation']}}" @endif>
            </div>
        </div>
        <div class="col-md-6">
                <div class="form_group">
                        <label class="form_label form_text">P O Box <span>*</span></label>
                    <input class="form_input " name="bank_po" id="bank_po" placeholder="P O Box"
                    @if(@$form_data['bankPolicy']['bankPo']!='') value="{{@$form_data['bankPolicy']['bankPo']}}" @endif>
                </div>
        </div>
        <div class="col-md-6">
            <div class="form_group">
                    <label class="form_label form_text">Amount to be assigned to the bank<span>*</span></label>
                <input class="form_input number" name="bank_amount" id="bank_amount" placeholder="Amount to be assigned " 
                @if(@$form_data['bankPolicy']['bankAmount']!='') value="{{number_format(trim(@$form_data['bankPolicy']['bankAmount']),2)}}" @endif>
            </div>
        </div>
    </div>
</div>
