                                            ...
                                            <table class="comparison table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input class="form_input number" name="premium" id="premium" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['premium']!=''){{@$pr_amount}}@endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="">
                                            <table class="comparison table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="text" name="no_of_installments" id="No of Installments"  class="form_input" value="@if(@$pipeline_details['accountsDetails']['noOfInstallment']!=''){{@$pipeline_details['accountsDetails']['noOfInstallment']}}@endif">
                                                    </td>
                                                </tr>
                                                </tbody>
