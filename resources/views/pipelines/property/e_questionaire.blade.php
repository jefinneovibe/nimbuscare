    ...
    <div class="section_details">
        ...
        <div class="card_content">
            ...
            <div class="edit_sec clearfix">
                ...
                <section>
                    <nav> <ol class="cd-breadcrumb triangle">
                        ...
                        @elseif($PipelineItems['status']['status']=='E-slip')
                            ...
                            <li class="current"><a href="{{url('property/e-slip/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li><em>E-quotation</em></li>
                            <li><em>E-Comparison</em></li>
                            <li><em>Quote Amendment</em></li>
                            <li><em>Approved E Quote</em></li>
                        ...
                        @elseif($PipelineItems['status']['status']=='E-quotation')
                            <li class="active_arrow"><em>E-Questionnaire</em></li>
                            <li class="complete"><a href="{{url('property/e-slip/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li class="current"><a href="{{url('property/e-quotation/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-quotation</em></a></li>
                            <li><em>E-Comparison</em></li>
                            <li><em>Quote Amendment</em></li>
                            <li><em>Approved E Quote</em></li>
                            {{--<li><em>Issuance</em></li>--}}
                        @elseif($PipelineItems['status']['status']=='E-comparison')
                            <li class="active_arrow"><em>E-Questionnaire</em></li>
                            <li class="complete"><a href="{{url('property/e-slip/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li class="complete"><a href="{{url('property/e-quotation/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-quotation</em></a></li>
                            <li class="current"><a href="{{url('property/e-comparison/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li><em>Quote Amendment</em></li>
                            <li><em>Approved E Quote</em></li>
                            {{--<li><em>Issuance</em></li>--}}
                        @elseif($PipelineItems['status']['status']=='Approved E Quote')
                            ...
                            <li class="complete"><a href="{{url('property/e-slip/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Slip</em></a></li>
                            <li class="complete"><a href="{{url('property/e-quotation/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-quotation</em></a></li>
                            <li class="complete"><a href="{{url('property/e-comparison/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li class="complete"><a href="{{url('property/quot-amendment/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                            <li class="current"><a href="{{url('property/approved-quot/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>Approved E Quote</em></a></li>
                            {{--<li><em>Issuance</em></li>--}}
                        @elseif($PipelineItems['status']['status']=='Quote Amendment')
                            ...
                            <li class="complete"><a href="{{url('property/e-quotation/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-quotation</em></a></li>
                            <li class="complete"><a href="{{url('property/e-comparison/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>E-Comparison</em></a></li>
                            <li class="current"><a href="{{url('property/quot-amendment/'.$eQuestionnaireid)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                            <li><em>Approved E Quote</em></li>
                            {{--<li><em>Issuance</em></li>--}}
                ...
                @include('pipelines.property.form_includes.e_questionnaire_form')
...
$('#percentage_cladding').change(function () {
            var cladding_presence = $('#percentage_cladding').val();
                if(cladding_presence!='')
                {
                    $('#percentage_cladding-error').hide();
                }else{
                    $('#percentage_cladding-error').show();
                }
...
//bank mortage
$('#bank_mortage').change(function(){
    var bank= $('#bank_mortage').val();
    if(bank=='no'){
        $('#bankMortage_yes').hide();
    }
    else{
        $('#bankMortage_yes').show();
    }
...
//bank mortage/
        ...
        $('#business_interruption').change(function () {
            ...
            if(business_interruption=='no')
            {
                ...
                $("#claim_experience_details option[value='separate_property']").addClass('disable_val');
                $("#claim_experience_details option[value='combined_data']").addClass('disable_val');
                $("#claim_experience_details option[value='only_property']").removeClass('disable_val');
                $('#fire_perils').hide();
                // if($('#is_edit').val()==1)
                // {
                ...
                $("#claim_experience_details option[value='only_property']").addClass('disable_val');

                $("#claim_experience_details option[value='separate_property']").removeClass('disable_val');
           ...
           {
            claim_data='Combined data for Property and Business interruption coverages';
            $('#fire_perils').hide();
...
//         //form validation
    $('#e_quest_form').validate({
        ...
        messages: {
            ...
            bank_mortage: "Please select bank mortgage details.",
        ...
        errorPlacement: function (error, element) {
            ...
            || element.attr("name") == "construction_walls" || element.attr("name") == "floor" || element.attr("name") == "year_construction"
             ...
             || element.attr("name") == "time_day" || element.attr("name") == "once_day" || element.attr("name") == "security_guard" || element.attr("name") == "percentage_cladding"|| element.attr("name") == "burglary_alarm"
        ...
        submitHandler: function (form,event) {
            ...
            $.ajax({
                method: 'post',
                url: '{{url('property/equestionnaire-save')}}',
                data: form_data,
                cache : false,
                contentType: false,
                processData: false,
                success: function (result) {
                    if (result== 'success') {
                        window.location.href = '{{url('property/e-slip/'.$eQuestionnaireid)}}';
                    }
                }
            });
...
else if(id=='others2')
{
    ...
    $('#btn-send').on('click', function () {
        ...
        $.ajax({
            method: 'post',
            url: '{{url('property/send-questionnaire')}}',
            data: form_data,
            cache : false,
            contentType: false,
            processData: false,
