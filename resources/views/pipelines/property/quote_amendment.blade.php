                ...
                <section>
                    <nav>
                        <ol class="cd-breadcrumb triangle">
                            <li class="complete"><em><a href="{{ url('property/e-questionnaire/'.$pipeline_details->_id) }}">E-Questionnaire</a></em></li>
                            <li class="complete"><em><a href="{{ url('property/e-slip/'.$pipeline_details->_id) }}">E-Slip</a></em></li>
                            <li class="complete"><em><a href="{{ url('property/e-quotation/'.$pipeline_details->_id) }}">E-Quotation</a></em></li>
                            <li class="complete"><a href="{{url('property/e-comparison/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>E-Comparision</em></a></li>
                            @if($pipeline_details['status']['status'] == 'Approved E Quote')
                                <li class = active_arrow><a href="{{url('property/quot-amendment/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                                <li class = "current"><a href="{{url('property/approved-quot/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>Approved E Quote</em></a></li>
                            ...
                            @else
                                <li class = current><a href="{{url('property/quot-amendment/'.$pipeline_details->_id)}}" style="color: #ffffff;"><em>Quote Amendment</em></a></li>
                                        ...
                                        <table class="table table-bordered"  style="border-bottom: none">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['adjBusinessClause']}}</div></td>
                                                </tr>
                                                @if(isset($pipeline_details['formData']['stock']) && $pipeline_details['formData']['stock']!='')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['stockDeclaration']}}</div></td>
                                                    </tr>
                                                @endif
                                                @if(isset($pipeline_details['formData']['annualRent']) && $pipeline_details['formData']['annualRent']!='')
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['lossRent']}}</div></td>
...
$pipeline_details['formData']['businessType']=="Hotel multiple cover")
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['personalStaff']}}</div></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['coverInclude']}}</div></td>
                                                    </tr>
                                                @endif
...
|| $pipeline_details['formData']['businessType']=="Warehouse/ cold storage"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['seasonalIncrease']}}</div></td>
                                                    </tr>
                                                @endif
                                                @if($pipeline_details['formData']['occupancy']['type']=='Residence')
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['coverAlternative']}}</div></td>
                                                    </tr>
                                                @endif
                                                @if($pipeline_details['formData']['businessType']=="Cafes & Restaurant"
|| $pipeline_details['formData']['businessType']=="Clothing manufacturing"
...
|| $pipeline_details['formData']['businessType']=="Warehouse/ cold storage"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['coverExihibition']}}</div></td>
                                                    </tr>
                                                @endif
...
||  @$pipeline_details['formData']['occupancy']['type']=='Others')
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['coverProperty']}}</div></td>
                                                    </tr>
                                                @endif
                                                @if($pipeline_details['formData']['otherItems']!='')
                                                    <tr>
                                                        ...
                                                        <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['propertyCare']}}</div></td>
                                                    </tr>
                                                @endif
                                                <tr>
                                                    <td><div class="main_question"><label class="form_label bold">Loss payee clause</label></div></td>
                                                    <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['lossPayee']}}</div></td>
                                                </tr>
...
|| $pipeline_details['formData']['businessType']=="Museum/ heritage sites"
                                                    ...
                                                    @if($pipeline_details['formData']['coverCurios']==true)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="main_answer"><div class="ans">{{$pipeline_details['formData']['coverCurios']}}</div></td>
                                                        </tr>
                                                    @endif
                                                @endif
