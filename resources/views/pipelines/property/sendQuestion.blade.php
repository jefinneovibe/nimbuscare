...
//         //form validation
    $('#e_quest_form').validate({
        ...
        messages: {
            ...
            percentage_cladding: "Please select percentage of cladding.",
            ...
            bankname: "Please enter bank aame",
        ...
        errorPlacement: function (error, element) {
            ...
            || element.attr("name") == "construction_walls" || element.attr("name") == "floor" || element.attr("name") == "year_construction"
             ...
             || element.attr("name") == "time_day"  || element.attr("name") == "once_day" || element.attr("name") == "security_guard" || element.attr("name") == "burglary_alarm"
             || element.attr("name") == "cctv"  || element.attr("name") == "electicity_usage" || element.attr("name") == "distance" || element.attr("name") == "percentage_cladding" || element.attr("name") == "water_storage"
