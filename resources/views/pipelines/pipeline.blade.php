    ...
    <div class="data_table" style="margin-bottom: 0">
        <div class="tabbed clearfix">
            <ul>
                ...
                {{-- <li class="blue-bg"><a href="{{ url('lost-business') }}">Lost Business</a></li> --}}
            </ul>
        </div>
        <div id="admin">
            <div class="material-table table-responsive">
                <div class="table-header">
                    <span class="table-title">Pipeline</span>
                    <div class="actions">
                        <div class="sort">
                            <label>Sort :</label>
                        ...
                        <div class="dropdown">
                            ...
                            <form method="post" action="/export-pipeline">
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a target="_blank" href="{{url('/export-pipeline')}}" class="dropdown-item" id="btn-exel">Export As Excel</a>
                                </div>
                            </form>
                        </div>
                ...
                <form id="filterForm" name="filterForm" action="{{URL::to('pipelines')}}" method="get">
...
//        }
        ...
        $('#datatable').dataTable({
            ...
            ajax: {
                type:'post',
                url:'{{\Illuminate\Support\Facades\URL::to('pipelines/data')}}',
                data: function(d){
                    d.field=sortField;
                    d.searchField="";
                    d.filterData=filter;
