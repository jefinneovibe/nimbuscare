    ...
    <div class="section_details">
        ...
        <div class="card_content">
            <div class="edit_sec clearfix">
                ...
                {{--<li class="complete"><a href="{{url('quot-amendment/'.$pipelineId)}}" style="color: #ffffff;"><em>Quote Ammendment</em></a></li>--}}
                                        ...
                                        <div class="">
                                            <table class="comparison table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input  name="insurer_discount" id="insurer_discount" class="form_input number" onkeyup="commission()"
                                                         @if(isset($pipeline_details['accountsDetails'])&& $pipeline_details['accountsDetails']['insurerDiscount'])
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="iib_discount" id="iib_discount" class="form_input number" onkeyup="commission()" 
                                                        @if(isset($pipeline_details['accountsDetails']) && $pipeline_details['accountsDetails']['iibDiscount'])
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="insurer_fees" id="insurer_fees" class="form_input number" onkeyup="commission()" 
                                                        @if(isset($pipeline_details['accountsDetails']) && $pipeline_details['accountsDetails']['insurerFees'])
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="iib_fees" id="iib_fees" class="form_input number" onkeyup="commission()"
                                                         @if(isset($pipeline_details['accountsDetails']) && $pipeline_details['accountsDetails']['iibFees'])
