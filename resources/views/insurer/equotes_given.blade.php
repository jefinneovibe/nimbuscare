        ...
        <div id="admin">
            <div class="material-table table-responsive">
                <div class="table-header">
                    <span class="table-title">E-quotes Given</span>
                    <div class="actions">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a target="_blank" href="{{url('insurer/exel-given')}}" class="dropdown-item" id="btn-exel">Export As Excel</a>
                            </div>
                        </div>
...
@endforelse
                        ...
                        <th class="disabled_sort sorting_disabled">Given By</th>
                ...
                {{--<div class="cd-popup-container">--}}
                    {{--<div class="modal_content">--}}
                        ...
                        {{--<div class="content_spacing clearfix">--}}
                            {{--<div class="md--half" id="categoryList">--}}
                                {{--<h5>Category</h5>--}}
                                {{--<div class="pre-scrollable">--}}
                                    {{--<div class="custom_checkbox">--}}
                                ...
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="md--half" id="mainGroupList">--}}
                                {{--<h5>Main Groups</h5>--}}
                                {{--<div class="pre-scrollable">--}}
                                    {{--<div class="custom_checkbox">--}}
                                ...
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="md--half" id="caseManagerList">--}}
                                {{--<h5>Case Managers</h5>--}}
                                {{--<div class="pre-scrollable">--}}
                                    {{--<div class="custom_checkbox">--}}
                                ...
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="md--half" id="agentList">--}}
                                {{--<h5>Agents</h5>--}}
                                {{--<div class="pre-scrollable">--}}
                                    {{--<div class="custom_checkbox">--}}
...
//        console.log(selected_arrays);
        ...
        $(document).ready(function() {
            ...
            if(localStorage)
            {
                if(localStorage.getItem('searchField_given'))
                {
                    searchField = localStorage.getItem('searchField_given')
                    $('#e_quot_search').val(searchField);
                }
                if(localStorage.getItem('sortField_given'))
                {
                    sortField = localStorage.getItem('sortField_given');
            ...
            $('#datatable').dataTable({
                ...
                ajax: {
                    type:'post',
                    url: '{{\Illuminate\Support\Facades\URL::to('insurer/given-equots')}}',
                    data: function(d){
                        d.field=sortField;
                        d.searchField="";
                ...
                "columns": [
                    ...
                    {"data": "givenBy", "searchable": true, "visible": true, "orderable": false},
            ...
            $('#e-quot_sort').on('change', function () {
                localStorage.setItem('sortField_given', $('#e-quot_sort').val());
                location.reload();
            });

            $('#e_quot_search').on('keyup', function(){
                localStorage.setItem('searchField_given',$('#e_quot_search').val());
                var table = $('#datatable').DataTable();
