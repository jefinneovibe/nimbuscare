...
@section('content')
    ...
    <div class="data_table" id="data" style="display: none">
            ...
            <div class="material-table table-responsive">
                ...
                <form>
                    ...
                    @if(isset(session('permissions')['lead']))
                        <button id="submit_all" name="submit_all" type="button" class="btn btn-primary btn_action btn pull-right">Submit</button>
                ...
                <div class="modal_content">
                    ...
                    <form method="post" name="dispatch_slip_form" id="dispatch_slip_form">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom_select assignDiv">
                                                    <select class="selectpicker" data-hide-disabled="true" data-live-search="true" name="employee_list" id="employee_list" onchange="showtype(this);">
                            ...
                            <div class="card_separation" style="margin: 20px -20px 0;padding: 20px 20px;border-left: none;border-right: none;">
                                ...
                                <table class="lead_block input_fields_wrap" id="document_div" width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <div >
                                                <div class="form_group" id="formlabel" style="display: none">
                                                    <label {{--style="visibility:hidden"--}} class="form_label" id="amountlabel"  >Amount / No Of Cards<span>*</span></label>
                                                    <input type="number"  class="form_input" name="doc_amount[]"  style="display:none" id="doc_amount"  placeholder="Amount">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                        ...
                        <div class="modal_footer">
                            <button class="btn btn_cancel" id="cancel_save" onclick="setsaveDetails(this.id)" type="button">Close</button>
                            @if(isset(session('permissions')['lead']))
...
//                $('#preLoader').show();
        ...
        * Filter implementation*/
        ...
        function setsaveDetails(id)
        {
            ...
            if(id=='save_button' || id=='cancel_save')
            {
        ...
        $(document).on('click','.add_field_button',function(e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $('.input_fields_wrap').append('' +
                    ...
                    '<td>' +
                    ' <div >' +
                    ' <div class="form_group" id="formlabel">' +
                    '                                            <label style="visibility:hidden" id="amountlabel_"  class="form_label">Amount / No Of Cards<span>*</span></label>' +
                    '                                            <input class="form_input" min="0" type="number"  name="doc_amount[]" style="display: none" id="doc_amount_' + x + '" type="number" placeholder="Amount">' +
                    '                                        </div>' +
                    '                                    </div>'+
                    '</td>'+
                    '<td>' +
