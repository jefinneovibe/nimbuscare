                        ...
                        <table class="mn_tbl_bg" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff" style="width: 100%;border-radius: 8px;text-align: center">
                            <tr>
                                <td>
                                    ...
                                    <h1 class="title" style="margin: 0;color: #078ac8;font-size: 20px;font-weight: 700;text-transform: uppercase;"> Lead  @if($saveMethod =='reject_button') Rejected @elseif($saveMethod =='submitt_button') Delivered @elseif($saveMethod =='approve_button') Approved @endif </h1>
                                    ...
                                    @if($leadss !="" && @$documents)
                                        <div class="mn_info" style="text-align: left">
                                            ...
                                            <br>
                                            <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                                <br>For any clarifications please contact <a href="mailto:info@iibcare.com">info@iibcare.com</a> or call  (+971) 042944399 (Sunday-Thursday, 7:30am to 5:00pm)</br>
                                            </h2>
                                        </div>
                                    ...
                                    <div class="mn_info" style="text-align: left">
                                        ...
                                        <div style="height: 18px;"></div>
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            {{--Your Lead (ReferenceNo:<span style="color:blue">{{$referencenumber}}</span>) has been Delivered to {{$action}} By <span style="color: #0AD5C1">{{$name}}</span>.--}}
                                            {{--@if(@$prefered_date)--}}
                                                {{--It will be delivered by {{$prefered_date}}.--}}
                                            {{--@endif--}}
                                            {{--Please Check.--}}
                                            Your recent request for Delivery/Collection with reference number<span style="color:blue">{{$referencenumber}}</span> is currently in progress.Our representative will get in touch with you shortly.
                                        </h2>
                                        <br>
