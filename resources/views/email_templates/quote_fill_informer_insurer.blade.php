                        ...
                        <table class="mn_tbl_bg" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff" style="width: 100%;border-radius: 8px;text-align: center">
                            <tr>
                                <td>
                                    ...
                                    <h1 class="title" style="margin: 0;color: #078ac8;font-size: 20px;font-weight: 700;text-transform: uppercase;"> Quote Provided Notification</h1>
                                    ...
                                    <div class="mn_info" style="text-align: left">
                                        ...
                                        <h1 style="color: rgba(0,0,0,0.7);font-size: 16px;font-weight: 500;margin: 0">Dear <span style="color: #44acd8"> @if (strtolower(@$name) != 'admin')
                                                Sir/Madam,
                                            @else
                                                {{@$name}},
                                            @endif </span></h1>
                                        ...
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            You are provided a reply for the policy of {{@$customerName}}.
                                        </h2>
                                        <br>
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            The reply is attached as pdf with this mail.
                                        </h2>
                                        <br>
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
