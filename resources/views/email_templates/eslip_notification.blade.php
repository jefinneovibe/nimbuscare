                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="mn_info" style="text-align: left">
                                        ...
                                        <h1 style="color: rgba(0,0,0,0.7);font-size: 16px;font-weight: 500;margin: 0">Dear
                                            <span style="color: #44acd8">
                                        ...
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            You have received a request for quotation for {{@$type}} policy.
                                        ...
                                        <br>
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            If you wish to give the quote manually, please update the attached excel sheet and send it across to IIB Team.
                                        </h2>
                                        @if($comment!=null)
                                            <br>
