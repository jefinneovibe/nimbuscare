                        ...
                        <table class="mn_tbl_bg" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff" style="width: 100%;border-radius: 8px;text-align: center">
                            <tr>
                                <td>
                                    ...
                                    <h1 class="title" style="margin: 0;color: #078ac8;font-size: 20px;font-weight: 700;text-transform: uppercase;"> Quotation for {{$workType}} </h1>
                                    <hr style="height: 2px;background-color: #f1f4f7;border: none">
                                    <div style="height: 20px;"></div>


                                    <div class="mn_info" style="text-align: left;width: 600px;">
                                        ...
                                        <br>
                                        Reference Number : <span style="color: #44acd8">{{$refNo}}</span>
                                        <div style="height: 18px;"></div>
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            Please click on the below button to view the quotation for {{$workType}}.</h2>
                                        <br>  <a style="color:#FFFFFF;text-decoration:none;text-transform:  uppercase;font-weight:  600;font-size: 14px;" href="{{$link}}" target="_blank"><table class="emailButton" style="background-color: #29b6f9;border-radius: 4px" width="300" cellspacing="0" cellpadding="0" border="0" align="center">
                                                <tbody><tr>
                                        ...
                                        <div style="width:100%;">
                                            <br><h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">If the above button is not working, please click the following link to fill the e-questionnaire</h2></br>
                                            <br><h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0"><a href="{{$link}}">{{$link}}</a></h2></br>
                                        </div>
                                        @if($comment!=null)
                                            <br>
                                            <div style="border: black solid">
                                                <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">Comment : {{$comment}}</h2>
                                            </div>
                                        @endif
                                        <br>
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
