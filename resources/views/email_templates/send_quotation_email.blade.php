                        ...
                        <table class="mn_tbl_bg" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff" style="width: 100%;border-radius: 8px;text-align: center">
                            <tr>
                                <td>
                                    ...
                                    <h1 class="title" style="margin: 0;color: #078ac8;font-size: 20px;font-weight: 700;text-transform: uppercase;"> E-Quotation Details</h1>
                                    ...
                                    <div class="mn_info" style="text-align: left">
                                        ...
                                        <h1 style="color: rgba(0,0,0,0.7);font-size: 16px;font-weight: 500;margin: 0">Dear <span style="color: #44acd8">
                                            {{$pipeline_details['customer']['name']}} ,
                                            @if (strtolower(@$pipeline_details['customer']['name']) != 'admin')
                                                Sir/Madam,
                                            @else
                                                {{@$pipeline_details['customer']['name']}},
                                            @endif
                                        ...
                                        <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                            Please use the following link to view E-Quotation.</h2>
                                        <br>  <a style="color:#FFFFFF;text-decoration:none;text-transform:  uppercase;font-weight:  600;font-size: 14px;" href="{{$link}}" target="_blank"><table class="emailButton" style="background-color: #29b6f9;border-radius: 4px" width="300" cellspacing="0" cellpadding="0" border="0" align="center">
                                                <tbody><tr>
                                                    <td class="buttonContent" style="padding: 12px 0px" valign="middle" align="center">
                                                        ...
                                                        {{--<a style="color:#FFFFFF;text-decoration:none;text-transform:  uppercase;font-weight:  600;font-size: 14px;" href="{{@$url}}" target="_blank">Click Here to Pay</a>--}}
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
