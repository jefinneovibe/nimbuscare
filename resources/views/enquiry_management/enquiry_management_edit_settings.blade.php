        ...
        <div class="email_sec clearfix">
            <form id="add_credential">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form_group">
                            ...
                            <input type="text" class="form_input" name="username" id="username" placeholder="email" value="{{$data->userID}}" >
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form_group">
                            <label class="form_label">Password<span>*</span></label>
                            <input class="form_input" name="password" id="password" placeholder="Password" value="{{$data->passWord}}" type="password" autocomplete="off">
                        </div>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form_group">
                            ...
                            <input class="form_input" name="confirm_passWord" id="confirm_passWord" value="{{$data->passWord}}" placeholder="Confirm Password" type="password" autocomplete="off">
                        </div>
                    </div>

                    {{-- <div class="col-md-6">
                        <div class="custom_checkbox">
                            <input type="checkbox" name="auto_renew" id="auto_renew" @if($data->autorenew==1) value="true" checked @endif value="true" class="inp-cbx"  style="display: none">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-md-6 employee_selectbox">
                        ...
                        <select class="selectpicker" data-hide-disabled="true" data-live-search="true" name="assign_employee" id="assign_employee">
                            ...
                            @if(!empty($employees))
                                <option value="999" @if($data->assignEmployee=="999") selected @endif>All</option>
...
$('#add_credential').validate({
    ...
    submitHandler: function(form)
    {
        ...
        $.ajax({
            type:"post",
            url:"{{url('enquiry/edit-credentials')}}",
