                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="mn_info" style="text-align: left">
                                            ...
                                            <h1 style="color: rgba(0,0,0,0.7);font-size: 16px;font-weight: 500;margin: 0">Dear <span style="color: #44acd8">{{$name}},</span></h1>
                                            <br>
                                            <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                                {{-- <div>Dear customer,</div> --}}
                                                <div>
                                                   Reminder for following mails.
                                                </div>
                                                <div>
                                                    <?php $count=1;?>
                                                @foreach ($mailSubject as $mail)
                                                <div>
                                                    {{$count}} : <span style="color:#078ac8">{{$mail}}</span>
                                                </div>
                                                <?php $count++;?>
                                                @endforeach
                                            </h2>
                                            <h2 style="color: rgba(0,0,0,0.7);font-weight: 500;line-height: 22px;font-size: 14px;margin: 0">
                                                ...
                                                or call  (+971) 042944399 (Sunday-Thursday, 7:30am to 5:00pm)</br>
                                            </h2>
                                            ...
                                            <div class="wishes" style="text-align: left">
                                                ...
                                                <div style="height: 5px;"> Team Interactive</div>
                                            </div>
                                            <div style="height: 10px;"></div>
                                        </div>
