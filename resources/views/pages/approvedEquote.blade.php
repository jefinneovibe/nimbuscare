...
@section('content')
@if(isset($formValues['insurerResponse']['response']) && @$formValues['insurerResponse']['response']!='')
{{-- <span class="pull-right" style="font-size:10px;margin: 0 14px;font-weight: 600;background: #27a2b0;color: #fff;padding: 4px 18px;text-transform: uppercase;border-radius: 47px;">
    {{$pipeline_details['insurerResponse']['response']}} by the Insurer</span> --}}
    <div class="text-right">
        <label class="badge badge-info">{{$pipeline_details['insurerResponse']['response']}} by the Insurer</label>
    </div>
@endif
<form name="accounts" id="accounts" method="post">
<input type="hidden" id="workTypeDataId" name="workTypeDataId" value="{{@$workTypeDataId}}">
    <div class="dataatable comparesec approvedquote">
        <div id="admins">
                                    ...
                                    <tr>
                                        @if(@$Insurer)
                                            @foreach(@$Insurer as $key =>$Insurer1)
                                                <th>
                                                    <div class="ans">
                                                        {{@$Insurer1['insurerDetails']['insurerName']}}
                                                    </div>
                                                </th>
                                            @endforeach
                                        @endif
                                            ...
                                            <tr class="">
                                                @if(count(@$Insurer1)>0)
                                                    @foreach(@$Insurer1 as $key1 =>$Insurerr)
                                                        ...
                                                        //     {{@$Insurer2['customerDecision']['decision']}} @if($Insurer2['customerDecision']['rejectReason']) (Reason: {{@$Insurer2['customerDecision']['rejectReason']}} ) @endif
                                                        //     <br>
                                        ...
                                        @endforeach
                                            <tr>
                                                @if(@$Insurer)
                                                        ...
                                                        @if(@$Insurer2['customerDecision']['comment'])                                                             <br>
        ...
        <div class="row">
            <div class="col-6 border_line">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Insurer Policy Number</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">IIB Policy Number</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Premium Invoice</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Premium Invoice Date</label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Commission Invoice</label>
                    ...
                    <div class="col-6 form-group">
                        <label class="title">Enter Commission Invoice Date</label>
                        <div class="input-group">
                ...
                <div class="row">
                    <div class="col-6 form-group">
                        <label class="title">Inception Date</label>
                        <div class="input-group">
            ...
            <div class="col-6">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Premium (Excl VAT) </label>
                            <div class="input-group">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">VAT % </label>
                            <input type="number" id="vat" name="vat" class="form-control commission" onkeyup="commission()"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">VAT (Total)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">AED</span>
                                    </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Commission %</label>
                            <input type="number" name="commision" id="commision" class="form-control"onkeyup="commission()"  value="@if($pipeline_details['accountsDetails']['commissionPercent']!=''){{round(@$pipeline_details['accountsDetails']['commissionPercent'],2)}}@elseif($pipeline_details['insurer_premium']!=''){{round(@$pipeline_details['insurer_brokerage'],2)}}@endif" placeholder="Enter Commission %">
                        </div>
                    </div>
                </div>
                <div class="row">
                     <div class="col-6">
                        <div class="form-group">
                            <label class="title">Commission Amount (Premium)</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                            ...
                            {{-- <input type="text" class="form-control number" id="commission_premium_amount" onkeyup="commissionPercent()" name="commission_premium_amount" onblur="commission()"
                                @if(isset($pipeline_details['accountsDetails']))
                                    value="{{$pipeline_details['accountsDetails']['commissionPremium']}}"
                                {{-- @else
                                    value="0"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Commission Amount (VAT)</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                            ...
                            {{-- <input id="commission_vat_amount"  class="form-control number" onkeyup="commission()" name="commission_vat_amount" readonly
                                @if(isset($pipeline_details['accountsDetails']))
                                    value = "@if($pipeline_details['accountsDetails']['commissionVat']!=''){{number_format($pipeline_details['accountsDetails']['commissionVat'])}}@endif"
                                {{-- @else
                                    value="0"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Insurer Discount</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                            ...
                            {{-- <input type="text" class="form-control number"  name="insurer_discount" id="insurer_discount" placeholder="Enter Insurer Discount" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['insurerDiscount']!=''){{number_format(@$pipeline_details['accountsDetails']['insurerDiscount'])}}@endif"> --}}
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">IIB Discount</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                            ...
                            {{-- <input type="text" class="form-control number" name="iib_discount" id="iib_discount"  placeholder="Enter IIB Discount" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['iibDiscount']!=''){{number_format(@$pipeline_details['accountsDetails']['iibDiscount'])}}@endif"> --}}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">Insurer Fees</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                            ...
                            {{-- <input type="text" class="form-control number" name="insurer_fees" id="insurer_fees" placeholder="Enter Insurer Fees" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['insurerFees']!=''){{number_format(@$pipeline_details['accountsDetails']['insurerFees'])}}@endif"> --}}
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">IIB Fees</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                                    <input type="text" class="form-control  aed number" name="iib_fees" id="iib_fees" placeholder="Enter IIB Fees" onkeyup="commission()" @if(@$pipeline_details['accountsDetails']['iibFees']!='')value="{{number_format(@$pipeline_details['accountsDetails']['iibFees'])}}"@endif>

                                </div>
                            {{-- <input type="text" class="form-control number" name="iib_fees" id="iib_fees" placeholder="Enter IIB Fees" onkeyup="commission()" value="@if(@$pipeline_details['accountsDetails']['iibFees']!=''){{number_format(@$pipeline_details['accountsDetails']['iibFees'])}}@endif"> --}}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">NET Premium Payable To Insurer</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">AED</span>
                                </div>
                            ...
                            {{-- <input id="payable_to_insurer"  class="form-control number" name="payable_to_insurer" readonly
                                @if(isset($pipeline_details['accountsDetails']))
                                    value="@if($pipeline_details['accountsDetails']['payableToInsurer']!=''){{number_format($pipeline_details['accountsDetails']['payableToInsurer'])}}@endif"
                                {{-- @else
                                    value="0"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="title">NET Premium Payable By Client</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">AED</span>
                                    </div>
    ...
    <div class="contentbodytwo backgroundwhite">
        <div class="row">
            ...
            <div id="ChequeuDiv" @if(@$pipeline_details['accountsDetails']['paymentMode'] == 'Cheque')  style="display:block;" @else  style="display:none;" @endif  class="col-3">
                <div class="form-group">
                    <label class="title">Cheque No <span class="text-danger">*</span></label>
            ...
            <div class="col-3 ">
                <div class="form-group">
                    <label class="title">Date Payment Sent To Insurer</label>
                    <div class="input-group">
    ...
    <div class="contentbodytwo backgroundwhite">
        <div class="row">
            <div class="col-3">
                <label class="title">Number Of Installments :</label>
            </div>
            <div class="col-3">
                <div class="form-group">
    ...
    <div class="row justify-content-end commonbutton">
        <button type="submit" class="btn btn-primary btnload">SAVE AND SUBMIT</button>
        <!-- <button type = "button" class="btn btn-primary" onclick="saveApproved()">Save as Draft</button> -->
    </div>
    @endif
