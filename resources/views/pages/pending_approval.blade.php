...
<input type="hidden" id="page" name="page" value="pending">
                    ...
                    <div class="table_left_fix">
                        <div class="materialetable table-responsive">
                            <table class="table customer_table">
                                <thead>
                                    <tr>
                                        <th><div class="mainsquestion">
                                            <b class="blue">SELECTED INSURER: {{@$Insurer[0]['insurerDetails']['insurerName']}}</b>
                                        </div></th>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="agent_commission" type="number" class="form-control aed  number" name="agent_commission" onkeyup="reverseCalculation()" onblur="commission()"
                                @if(isset($pipeline_details['accountsDetails']))
    ...
    <div class="row justify-content-end commonbutton">
        <button type="submit" class="btn btn-primary btnload">Approve</button>
    </div>
