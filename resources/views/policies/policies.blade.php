    ...
    <div class="data_table" style="margin-bottom: 0">
        <div class="tabbed clearfix">
            <ul>
                ...
                <li class="grey-bg active"><a href="{{ url('policies') }}">Policies</a></li>
            </ul>
        </div>
        <div id="admin">
            <div class="material-table table-responsive">
                <div class="table-header">
                    <span class="table-title">Policies</span>
                    <div class="actions">
                        <div class="sort">
                            <label>Sort :</label>
                        ...
                        <div class="dropdown">
                            ...
                            <form method="post" action="/export-pipeline">
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a target="_blank" href="{{url('/policy-export')}}" class="dropdown-item" id="btn-exel">Export As Excel</a>
                                </div>
                            </form>
                        </div>
                ...
                <form id="filterForm" name="filterForm" action="{{URL::to('policies')}}" method="get">
                <table id="datatable" style="text-overflow: ellipsis">
                    <thead>
                    <tr>
                        <th class="disabled_sort">Reference No</th>
                        ...
                        <th class="disabled_sort @if(!empty(@$pipeData)) filter_active @endif" style="min-width: 196px;" >
                            <span>Policy Status</span>

                            <a class="po__trigger--center button" href="javascript:;" data-layer-id="policy_status_layer"><i class="material-icons">filter_list</i></a>
                        </th>

                        {{-- <th class="disabled_sort">Policy Status</th> --}}
                        ...
                        <th class="disabled_sort @if(!empty(@$insuranceCompanies)) filter_active @endif" style="min-width: 200px;">
                            <span>Insurer</span>
                            <a class="po__trigger--center button" href="javascript:;" data-layer-id="insurer_layer"><i class="material-icons">filter_list</i></a>
                        </th>
                        <th class="disabled_sort">Email ID 1</th>
                        <th class="disabled_sort">Email ID 2</th>
                        <th class="disabled_sort">Phone No 1</th>
                        <th class="disabled_sort">Phone No 2</th>
                        ...
                        <th class="disabled_sort">Policy Delivery Mode</th>
                        <th class="disabled_sort @if(!empty(@$caseManagers)) filter_active @endif" style="min-width: 239px;">
                            <span>Name of the underwriter</span>
                            <a class="po__trigger--center button" href="javascript:;" data-layer-id="case_manager_layer"><i class="material-icons">filter_list</i></a></th>
                        <th class="disabled_sort">Date payment sent to Insurer</th>
                        <th class="disabled_sort">Accounts Approver</th>
                        <th class="disabled_sort">Gross Premium</th>
                        <th class="disabled_sort">IIB Fees</th>
                        <th class="disabled_sort">Insurer Fees</th>
                        <th class="disabled_sort">IIB VAT</th>
                        <th class="disabled_sort">Insurer VAT</th>
                        <th class="disabled_sort">Total VAT</th>
                        <th class="disabled_sort">Commission %</th>
                        <th class="disabled_sort">Total Commission Amount</th>
                        <th class="disabled_sort">Agent Commission %</th>
                        <th class="disabled_sort">Agent Commission amount</th>
                        <th class="disabled_sort">IIB Commission %</th>
                        <th class="disabled_sort">IIB Commission Amount</th>
                        <th class="disabled_sort">Discount</th>
                        <th class="disabled_sort">Total Billed Premium</th>
                        <th class="disabled_sort">Total Premium payable by Customer</th>
                        <th class="disabled_sort">Premium Payable to Insurer</th>
                    ...
                    <div id="policy_status_layer" class="po__layer list">
                        <p>Policy Status</p>
                        <div class="filter_tr">
                            <select style='width: 200px' class='policy_status-data-ajax' id="policy_status-data-ajax" name="policy_status[]" multiple="multiple">
                                <option  @if (@$_GET['policy_status'] && in_array('approved', @$_GET['policy_status'])) selected  @endif value="approved">Approved</option>
                                <option @if (@$_GET['policy_status'] && in_array('lost business', @$_GET['policy_status'])) selected  @endif  value="lost business">Lost Business</option>
                            </select>
                        </div>
                        <div class="filter_tr_action">
                            <button class='popover_cancel' type="button">Cancel</button>
                ...
                <div id="insurer_layer" class="po__layer list">
                    <p>Insurer</p>
                    <div class="filter_tr">
                        <select style='width: 200px' class='insurer-data-ajax' id="insurer-data-ajax" name="insurer[]" multiple="multiple">
                            @if(!empty(@$insuranceCompanies))
                                @foreach(@$insuranceCompanies as $insurer)
...
//        console.log(selected_arrays);
        ...
        $(document).ready(function() {
            ...
            if(localStorage)
            {
                if(localStorage.getItem('policy_sortField'))
                {
                    sortField = localStorage.getItem('policy_sortField');
                    $('.current').html(sortField);
                }
                if(localStorage.getItem('searchField'))
                {
                    searchField = localStorage.getItem('policy_searchField')
            ...
            $('#datatable').dataTable({
                ...
                ajax: {
                    type:'post',
                    url:'{{\Illuminate\Support\Facades\URL::to('get-policy')}}',
                    data: function(d){
                        d.field=sortField;
                        d.searchField="";
                        d.filterData=filter;
                ...
                "columns":[
                    ...
                    // { "data": "insurenceDate","searchable": true, "visible" : true, "orderable" : false},
                    // { "data": "expDate","searchable": true, "visible" : true, "orderable" : false}
                    { "data": "referenceNumber","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "created_at","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "created_by","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "id","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "name","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "maingroup_id","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "mainGroup","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "pipelineStatus","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "department","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "category","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "agent","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "policyNumber","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "iib_policy","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "insurer","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "emailid_1","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "emailid_2","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "ph_1","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "ph_2","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "inception_date","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "expiry_date","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "currency","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "invoice_date","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "premium_invoice_no","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "commission_invoice_no","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "payment_mode","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "policy_delivery_mode","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "underwriter_name","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "date_send","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "approver","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "gross_premium","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "iib_fees","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "insurer_fees","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "iib_vat","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "insurer_vat","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "total_vat","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "commission","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "total_commission","searchable": true, "visible" : true, "orderable" : false},


                    { "data": "agent_commission","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "agent_amount","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "iib_commission","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "iib_amount","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "discount","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "total_bill","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "total_customer","searchable": true, "visible" : true, "orderable" : false},
                    { "data": "total_insurer","searchable": true, "visible" : true, "orderable" : false},
...
//                    },
            ...
            * Reload for sorting*/
            ...
            $('#customSort').on('change',function(){
                ...
                localStorage.setItem('policy_sortField',$('#customSort').val());
                location.reload();
            });
            /*
            * Keyup function for searching*/
            $('#search').on('keyup',function(){
                localStorage.setItem('policy_searchField',$('#search').val());
            ...
            * Filter implementation*/
            ...
            $('body').on('click', function (e) {
                $('[data-toggle="popover"]').each(function () {
                    ...
                    $("input[name='accountsDetails.insurenceCompany']").on('change', function(){
                        $('#insurerAll').prop('checked',false);
                    });
                    $('#insurerAll').on('change', function () {
                        if($('#insurerAll').is(":checked")) {
                            $("input[name='accountsDetails.insurenceCompany']").prop('checked',true);
                        }
                        else{
                            $("input[name='accountsDetails.insurenceCompany']").prop('checked',false);
                        }
