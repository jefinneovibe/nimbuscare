                                        ...
                                        <div class="">
                                            <table class="comparison table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="insurer_discount" id="insurer_discount" class="form_input number" onkeyup="commission()" value="{{@$pipeline_details['accountsDetails']['insurerDiscount']}}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="iib_discount" id="iib_discount" class="form_input number" onkeyup="commission()" value="{{@$pipeline_details['accountsDetails']['iibDiscount']}}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="insurer_fees" id="insurer_fees" class="form_input number" onkeyup="commission()" value="{{@$pipeline_details['accountsDetails']['insurerFees']}}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    {{--<td class="main_answer"></td>--}}
                                                    <td>
                                                        <input type="number" name="iib_fees" id="iib_fees" class="form_input number" onkeyup="commission()" value="{{@$pipeline_details['accountsDetails']['iibFees']}}">
                                                    </td>
                                                </tr>
                                                <tr>
