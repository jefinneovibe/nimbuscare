...
<div class="col-{{@$config['data']['style']['col_width']?:12}}">
    <div class="row">
        ...
        <div class="col-{{@$option['option_width']?:12}} custom-control three_rem_width custom-radio mb-3">
                <input name="{{@$config['data']['id']}}" @if(@$value[@$config['data']['valueKey']] == @$option['option_value']) checked="checked" @endif value="{{@$option['option_value']}}" class="custom-control-input {{@$field_id}}_optionsEach" id="{{@$option['option_id']}}" type="radio">
